...
<section>
  ...
  <div class="leftpanel">
    ...
    <div class="leftpanelinner">
      ...
      <ul class="nav nav-pills nav-stacked nav-bracket">
        ...
        <li class="active"><a href="layouts.html"><i class="fa fa-laptop"></i> <span>Skins &amp; Layouts</span></a></li>
      </ul>
  ...
  <div class="mainpanel">
    ...
    <div class="contentpanel">
        ...
        <h4 class="subtitle">Sticky Header</h4>
        ...
        <div class="mb20"></div>
        <button class="btn btn-primary btn-sm btn-stickyheader">See it in Action</button>
                
        <div class="mb30"></div>

        <h4 class="subtitle">Sticky Left Panel</h4>
        <p>You can enable the sticky left panel by adding <code>sticky-leftpanel</code> to the element <code>leftpanel</code>.</p>
        <pre>&lt;div class="leftpanel sticky-leftpanel"&gt;...&lt;/div&gt;</pre>
        <p>Take note that by making the leftpanel sticky the header should also be sticky to prevent broken layout.</p>
        <div class="mb20"></div>
        <p><button class="btn btn-primary btn-sm btn-stickyleftpanel">See it in Action</button></p>
        
        <div class="mb30"></div>

        <h4 class="subtitle">Collapsed Menu (For Large Screen Only)</h4>
        ...
        <div class="mb20"></div>
        <p><button class="btn btn-primary btn-sm btn-collapsedleft">See it in Action</button></p>
        
        <div class="mb30"></div>
        
        <h4 class="subtitle">Inverse Skin</h4>
        <p>This is an example of changing the color skin of this template affecting the left panel, header and right panel. Just add the below code into the <code>head</code>. There are only one skin available for now. More skins are available for the coming updates of this template.</p>
        <pre>&lt;link href="css/style.inverse.css" rel="stylesheet"&gt;</pre>
        <div class="mb20"></div>
        <p><button class="btn btn-primary btn-sm btn-changeskin">See it in Action</button></p>
...
<script>
    jQuery(document).ready(function(){
        ...
        if(jQuery.cookie('change-skin')) {
           jQuery('.btn-changeskin').text('Disable Skin'); 
        }
        ...
        jQuery('.btn-changeskin').click(function(){
            ...
            if(!s) {
                jQuery.cookie("change-skin", 'inverse', { path: '/' });
                jQuery('head').append('<link id="skinswitch" rel="stylesheet" href="css/style.inverse.css" />');
                jQuery('.btn-changeskin').text('Disable Skin'); 
            } else {
                jQuery.removeCookie('change-skin', { path: '/' });
                jQuery('#skinswitch').remove();
                jQuery('.btn-changeskin').text('See it in Action'); 
            }
        });
    });
</script>
