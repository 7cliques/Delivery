...
<div class="pageheader">
    <h2><i class="fa fa-edit"></i> Formas de Pagamento </h2>
        ...
        <div class="panel-body panel-body-nopadding">
            ...
            <form class="form-horizontal form-bordered">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" placeholder="Digite o nome da Formas de Pagamento" title="Formas de Pagamento" data-toggle="tooltip" data-trigger="hover" class="form-control tooltips" />
                    </div>
                </div>
